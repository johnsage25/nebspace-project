      ...
      <div className="container">
        <div className="bd-blog-section-title mb-40">
          <div className="row align-items-end">
            <div className="col-lg-6">
              <div
                className="bd-section-title-wrapper mb-0 wow fadeInLeft"
                data-wow-duration="1s"
                data-wow-delay=".3s"
              >
                <h2 className="bd-section-title mb-0">NEBS News</h2>
                <p>
                  It is our goal to provide age appropriate opportuniy for every
                  child enrolled in NEBS enrichment classes.
                </p>
              </div>
            </div>
            <div className="col-lg-6">
              <div
                className="bd-blog-navigation mb-15 wow fadeInRight"
                data-wow-duration="1s"
                data-wow-delay=".3s"
              >
        ...
        <div className="row">
          <div className="col-12">
            <div
              className="bd-blog-active wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay=".3s"
            >
              <div>
                    ...
                    return (
                      <SwiperSlide key={index}>
                        <div className="bd-blog">
                          ...
                          <div
                            className={`bd-blog-content ${
                              blog_wrap ? blog_wrap : ""
                            }`}
                          >
                            <div
                              className={`${
                                blog_date ? blog_date : "bd-blog-date"
                              }`}
                            >
                              <span>{item.date}</span>
                            </div>
            ...
            {blog_dot && (
              <div
                className="bd-blog-pagination bd-dots-pagination wow fadeInUp"
                data-wow-duration="1s"
                data-wow-delay=".3s"
              ></div>
            )}
