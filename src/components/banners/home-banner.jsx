...
import joiningBg from "@assets/img/bg/30717501_abstract_pattern_04_11.svg";
              ...
              >
                <div className="bd-section-title-wrapper is-white mb-45">
                  <h2 className="bd-section-title mb-0">
                    Gain access to exclusive features and bulk discounts
                  </h2>
                  <p>
                    Get textbooks and subscriptions for schools, therapy
                    offices, and homeschooling groups.
                  </p>
                </div>
