        ...
        <div className="row align-items-center">
          <div className="col-xl-6">
            <div className="bd-section-title-wrapper mb-45">
              ...
              <p>
                You've stumbled upon the elusive 404 Error page. Fear not;
                you're not lost forever. It happens to the best of us! Let's
                steer you back to smoother seas:
              </p>
            </div>
              ...
              <Link href="/" className="bd-btn">
                <span className="bd-btn-inner">
                  <span className="bd-btn-normal d-flex align-items-center">
                    <i className="flaticon-hut"></i>Back To Home
                  </span>
