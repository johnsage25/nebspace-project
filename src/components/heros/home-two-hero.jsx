...
import bg_1 from "@assets/img/hero/smart-hispanic-schoolgirl-with-backpack-turning-around.jpg";
import bg_2 from "@assets/img/hero/biracial-girl-with-diverse-class-desk-learning-school.jpg";
import bg_3 from "@assets/img/hero/slide-2-c.jpg";
...
const hero_data = [
    {
        ...
        shape: shape,
        bg: bg_1,
        subTitle: 'Discover the power of Applied Behavior Analysis (ABA) in shaping the future of special education.',
        title: 'Transforming Education for Special Needs',
        btn: 'Join for Free',
    },
    {
        id: 2,
        shape: shape,
        bg: bg_2,
        subTitle: 'Access a wealth of ABA resources designed to equip educators with the tools ',
        title: 'Empowering Special Needs Education',
        btn: 'Join for Free',
    },
    {
        id: 3,
        shape: shape,
        bg: bg_3,
        subTitle: 'Join our community tools dedicated to improving the lives of special needs students.',
        title: 'Unlocking Potential Together',
        btn: 'Join for Free',
    }
]
